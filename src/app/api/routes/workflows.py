...
async def execute_workflow(
    ...
    try:
        ...
        response = WorkflowResponse(
            ...
            } if result.workflow.completed else None,
...
async def execute_detection_workflow(
    request: Optional[WorkflowRequest] = None
):
    """
    ...
    try:
        ...
        raise HTTPException(status_code=500, detail=f"Detection workflow execution failed: {str(e)}")
...
async def get_workflow_status(run_id: str):
    ...
    try:
        ...
        status = WorkflowStatus(
            ...
            completed_steps=["initialize", "classify_domain", "plan_queries", "fetch_data", "process_data"],
            total_steps=5,
            progress=100.0,
...
async def get_workflow_config():
    ...
    try:
        ...
        raise HTTPException(status_code=500, detail=f"Workflow configuration retrieval failed: {str(e)}")
